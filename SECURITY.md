...
Este documento describe cómo reportar vulnerabilidades en **appclima-python** y qué prácticas de seguridad seguimos en el repositorio.
...
| Releases / tags         | Solo la última versión (v1.x) |

## Alcance

appclima-python es una aplicación de línea de comandos educativa que se ejecuta localmente. Superficies **en alcance** para reportes de seguridad:

- Código fuente del repositorio.
- Manejo de la clave de API de OpenWeatherMap y de otros secretos.
