...
¡Gracias por tu interés en contribuir a **appclima-python**! Esta guía describe el flujo de trabajo, los estándares de código y el proceso de Pull Requests.
...
- Líneas de máximo 88 caracteres (por defecto de `black`).
- Codificación UTF-8, finales de línea LF.

### Nombrado

- Sigue las convenciones idiomáticas de Python (p. ej. `camelCase`/`snake_case`/`PascalCase` según corresponda).
...
- Ejecuta la suite completa antes de abrir el PR (`pytest`).
